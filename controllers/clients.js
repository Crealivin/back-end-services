        ...
        if (req.client.id === clientId) {
            Client.update(bodyData, {where: {id: clientId}, returning: true})
                ...
                .then((data) => {
                    ...
                    return responseUtil.successResponse(res, null, {client: data});
                })
                .catch(err => {
...
router.put('/:clientId', verifyToken, verifyClient, updateClient);
router.patch('/changePassword', verifyToken, verifyClient, updatePassword);
router.delete('/:clientId', verifyToken, verifyClient, deleteClient);
